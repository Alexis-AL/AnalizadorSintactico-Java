...
public class FrmPrincipal extends javax.swing.JFrame {
     ...
     */
     ArrayList<Integer> enfadosita = new ArrayList<Integer>();
     
    private void enfadosa(){
    ...
    private void analizarLexico() throws IOException{
        ...
        while (true) {
            ...
            System.out.println("hhh"+expr);
            String errorOcho=expr;
            if (token == null) {
                System.out.println("holaaa"+expr);
            ...
            switch (token) {
                ...
                case Numero:
                    ...
                    break;
                case constante:
                    resultado += "  <Texto en comillas>\t\t" + lexer.lexeme + "\n";
                    break;
                case ERROR:
    ...
    private void initComponents() {
        ...
        arbolsintactico = new javax.swing.JTextArea();
        ...
        btnArchivo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/carpeta.png"))); // NOI18N
        ...
        txtAnalizarLex.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204), 2));
        jScrollPane2.setViewportView(txtAnalizarLex);

        btnAnalizarLex.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btnAnalizarLex.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/adelante.png"))); // NOI18N
        ...
        btnLimpiarLex.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/basura.png"))); // NOI18N
        ...
        jLabel1.setFont(new java.awt.Font("Cantarell Light", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/terminal(1).png"))); // NOI18N
        jLabel1.setText("Terminal");

        jLabel2.setFont(new java.awt.Font("Cantarell Light", 1, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/idioma(1).png"))); // NOI18N
        ...
        arbolsintactico.setColumns(20);
        arbolsintactico.setRows(5);
        jScrollPane3.setViewportView(arbolsintactico);

        jLabel5.setFont(new java.awt.Font("Cantarell Light", 1, 36)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/idioma(1).png"))); // NOI18N
    ...
    private void btnAnalizarSinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarSinActionPerformed
        ...
        try {
            ...
            s.parse();
            //System.out.println(s.debug_parse());
        ...
        try {
            String ST2 = new String(Files.readAllBytes(archivo.toPath()));
            arbolsintactico.setText(ST2);
        } catch (FileNotFoundException ex) {
            Logger.getLogger(FrmPrincipal.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
            Logger.getLogger(FrmPrincipal.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextArea arbolsintactico;
